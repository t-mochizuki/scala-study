...
},{"@apollo/client":9}],3:[function(require,module,exports){
(function (process){
'use strict';
    ...
    if (!field.selectionSet) {
        ...
        workSet_1.forEach(function (value) {
            if (value && typeof value === "object") {
                process.env.NODE_ENV === "production" ? tsInvariant.invariant(!utilities.isReference(value), 7) : tsInvariant.invariant(!utilities.isReference(value), "Missing selection set for object of type " + getTypenameFromStoreObject(store, value) + " returned for query field " + field.name.value);
...
var StoreWriter = (function () {
    ...
    StoreWriter.prototype.writeToStore = function (_a) {
        ...
        var ref = utilities.isReference(objOrRef) ? objOrRef :
            dataId && utilities.makeReference(dataId) || void 0;
        if (ref) {
...
var Policies = (function () {
    ...
    Policies.prototype.readField = function (options, context) {
        ...
        if (read) {
            var readOptions = makeFieldFunctionOptions(this, objectOrReference, options, context, this.storageTrie.lookup(utilities.isReference(objectOrReference)
...
},{"../utilities":15,"@wry/context":16,"@wry/equality":17,"_process":1,"optimism":42,"ts-invariant":50,"tslib":51}],4:[function(require,module,exports){
(function (process){
'use strict';
            ...
            if (writeWithErrors) {
                this.cache.performTransaction(function (cache) {
                    if (_this.lastWrittenResult &&
                        equality.equal(result.data, _this.lastWrittenResult.data) &&
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.stop = function () {
        ...
        this.cancelPendingFetches(process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(13) : new tsInvariant.InvariantError('QueryManager stopped while query was in flight'));
    };
    ...
    QueryManager.prototype.query = function (options) {
        var _this = this;
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query, 16) : tsInvariant.invariant(options.query, 'query option is required. You must specify your GraphQL document ' +
            'in the query option.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(options.query.kind === 'Document', 17) : tsInvariant.invariant(options.query.kind === 'Document', 'You must wrap the query string in a "gql" tag.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.returnPartialData, 18) : tsInvariant.invariant(!options.returnPartialData, 'returnPartialData option only supported on watchQuery.');
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(!options.pollInterval, 19) : tsInvariant.invariant(!options.pollInterval, 'pollInterval option only supported on watchQuery.');
...
function markMutationResult(mutation, cache) {
    if (!utilities.graphQLResultHasError(mutation.result)) {
        var cacheWrites_1 = [{
...
},{"../cache":3,"../errors":5,"../link/core":6,"../link/http":7,"../link/utils":8,"../utilities":15,"@wry/equality":17,"_process":1,"graphql-tag":19,"graphql/language/visitor":39,"ts-invariant":50,"tslib":51}],5:[function(require,module,exports){
'use strict';
...
},{"../utilities":15,"tslib":51}],6:[function(require,module,exports){
(function (process){
'use strict';
...
var ApolloLink = (function () {
    ...
    ApolloLink.prototype.request = function (operation, forward) {
        throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(22) : new tsInvariant.InvariantError('request is not implemented');
    };
...
},{"../../utilities":15,"../utils":8,"_process":1,"ts-invariant":50,"tslib":51}],7:[function(require,module,exports){
(function (process){
'use strict';
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(24) : new tsInvariant.InvariantError("Network request failed. " + label + " is not serializable: " + e.message);
...
var checkFetcher = function (fetcher) {
    if (!fetcher && typeof fetch === 'undefined') {
        throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(23) : new tsInvariant.InvariantError("\n\"fetch\" has not been found globally and no fetcher has been configured. To fix this, install a fetch package (like https://www.npmjs.com/package/cross-fetch), instantiate the fetcher, and pass it into your HttpLink constructor. For example:\n\nimport fetch from 'cross-fetch';\nimport { ApolloClient, HttpLink } from '@apollo/client';\nconst client = new ApolloClient({\n  link: new HttpLink({ uri: '/graphql', fetch })\n});\n    ");
    }
};
...
},{"../../utilities":15,"../core":6,"../utils":8,"_process":1,"graphql/language/printer":36,"ts-invariant":50,"tslib":51}],8:[function(require,module,exports){
(function (process){
'use strict';
...
function validateOperation(operation) {
    ...
    for (var _i = 0, _a = Object.keys(operation); _i < _a.length; _i++) {
        ...
        if (OPERATION_FIELDS.indexOf(key) < 0) {
            throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(25) : new tsInvariant.InvariantError("illegal argument: " + key);
        }
    }
    return operation;
}
...
},{"../../utilities":15,"_process":1,"ts-invariant":50,"tslib":51}],9:[function(require,module,exports){
'use strict';
...
},{"./core":4,"./react":14}],10:[function(require,module,exports){
(function (process){
'use strict';
...
var ApolloConsumer = function (props) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(context && context.client, 26) : tsInvariant.invariant(context && context.client, 'Could not find "client" in the context of ApolloConsumer. ' +
...
var ApolloProvider = function (_a) {
    ...
    return React.createElement(ApolloContext.Consumer, null, function (context) {
        ...
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(context.client, 27) : tsInvariant.invariant(context.client, 'ApolloProvider was not passed a client instance. Make ' +
...
},{"_process":1,"react":47,"ts-invariant":50}],11:[function(require,module,exports){
(function (process){
'use strict';
...
var OperationData = (function () {
    ...
    OperationData.prototype.refreshClient = function () {
        ...
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!client, 28) : tsInvariant.invariant(!!client, 'Could not find "client" in the context or passed in as an option. ' +
    ...
    OperationData.prototype.verifyDocumentType = function (document, type) {
        ...
        process.env.NODE_ENV === "production" ? tsInvariant.invariant(operation.type === type, 29) : tsInvariant.invariant(operation.type === type, "Running a " + requiredOperationName + " requires a graphql " +
...
},{"../../core":4,"../../errors":5,"../../utilities":15,"../parser":13,"@wry/equality":17,"_process":1,"ts-invariant":50,"tslib":51}],12:[function(require,module,exports){
(function (process){
'use strict';
...
function useApolloClient() {
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(client, 32) : tsInvariant.invariant(client, 'No Apollo Client instance can be found. Please ensure that you ' +
...
},{"../context":10,"../data":11,"@wry/equality":17,"_process":1,"react":47,"ts-invariant":50,"tslib":51}],13:[function(require,module,exports){
(function (process){
'use strict';
...
function parser(document) {
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(!!document && !!document.kind, 33) : tsInvariant.invariant(!!document && !!document.kind, "Argument of " + document + " passed to parser was not a valid GraphQL " +
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), 34) : tsInvariant.invariant(!fragments.length ||
        (queries.length || mutations.length || subscriptions.length), "Passing only a fragment to 'graphql' is not yet supported. " +
        "You must include a query, subscription or mutation as well");
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, 35) : tsInvariant.invariant(queries.length + mutations.length + subscriptions.length <= 1, "react-apollo only supports a query, subscription, or a mutation per HOC. " +
    ...
    var definitions = queries.length
        ...
        : mutations.length
            ? mutations
            : subscriptions;
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(definitions.length === 1, 36) : tsInvariant.invariant(definitions.length === 1, "react-apollo only supports one definition per HOC. " + document + " had " +
...
},{"_process":1,"ts-invariant":50}],14:[function(require,module,exports){
'use strict';
...
},{"./context":10,"./hooks":12,"./parser":13}],15:[function(require,module,exports){
(function (process){
'use strict';
...
function valueToObjectRepresentation(argObj, name, value, variables) {
    if (isIntValue(value) || isFloatValue(value)) {
        ...
        throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(52) : new tsInvariant.InvariantError("The inline argument \"" + name.value + "\" of kind \"" + value.kind + "\"" +
...
function checkDocument(doc) {
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc && doc.kind === 'Document', 44) : tsInvariant.invariant(doc && doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    var operations = doc.definitions
        .filter(function (d) { return d.kind !== 'FragmentDefinition'; })
        .map(function (definition) {
        if (definition.kind !== 'OperationDefinition') {
            throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(45) : new tsInvariant.InvariantError("Schema type definitions not allowed in queries. Found: \"" + definition.kind + "\"");
        }
        return definition;
    });
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(operations.length <= 1, 46) : tsInvariant.invariant(operations.length <= 1, "Ambiguous GraphQL document: contains " + operations.length + " operations");
    return doc;
}
...
function getQueryDefinition(doc) {
    ...
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(queryDef && queryDef.operation === 'query', 47) : tsInvariant.invariant(queryDef && queryDef.operation === 'query', 'Must contain a query definition.');
    return queryDef;
}
function getFragmentDefinition(doc) {
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.kind === 'Document', 48) : tsInvariant.invariant(doc.kind === 'Document', "Expecting a parsed GraphQL document. Perhaps you need to wrap the query string in a \"gql\" tag? http://docs.apollostack.com/apollo-client/core.html#gql");
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(doc.definitions.length <= 1, 49) : tsInvariant.invariant(doc.definitions.length <= 1, 'Fragment must have exactly one definition.');
    var fragmentDef = doc.definitions[0];
    process.env.NODE_ENV === "production" ? tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 50) : tsInvariant.invariant(fragmentDef.kind === 'FragmentDefinition', 'Must be a fragment definition.');
    return fragmentDef;
}
function getMainDefinition(queryDoc) {
    ...
    throw process.env.NODE_ENV === "production" ? new tsInvariant.InvariantError(51) : new tsInvariant.InvariantError('Expected a parsed GraphQL query with a query, mutation, subscription, or a fragment.');
}
...
},{"_process":1,"fast-json-stable-stringify":18,"graphql/language/visitor":39,"symbol-observable":48,"ts-invariant":50,"tslib":51,"zen-observable":52}],16:[function(require,module,exports){
'use strict';
...
},{"graphql/language/parser":34}],20:[function(require,module,exports){
"use strict";
...
},{"../jsutils/isObjectLike":26,"../language/location":33,"../language/printLocation":35,"../polyfills/symbols":40}],21:[function(require,module,exports){
"use strict";
...
},{"./GraphQLError":20}],22:[function(require,module,exports){
"use strict";
...
},{"./invariant":25,"./nodejsCustomInspectSymbol":27}],23:[function(require,module,exports){
"use strict";
...
},{"./nodejsCustomInspectSymbol":27}],25:[function(require,module,exports){
"use strict";
...
},{"../jsutils/defineInspect":22}],29:[function(require,module,exports){
"use strict";
...
},{"../error/syntaxError":21,"./ast":28,"./blockString":29,"./tokenKind":38}],33:[function(require,module,exports){
"use strict";
...
},{"../error/syntaxError":21,"../jsutils/devAssert":23,"../jsutils/inspect":24,"./ast":28,"./directiveLocation":30,"./kinds":31,"./lexer":32,"./source":37,"./tokenKind":38}],35:[function(require,module,exports){
"use strict";
...
},{"./location":33}],36:[function(require,module,exports){
"use strict";
...
},{"./blockString":29,"./visitor":39}],37:[function(require,module,exports){
"use strict";
...
},{"../jsutils/devAssert":23,"../polyfills/symbols":40}],38:[function(require,module,exports){
"use strict";
...
},{"../jsutils/inspect":24,"./ast":28}],40:[function(require,module,exports){
"use strict";
...
},{"@wry/context":16}],43:[function(require,module,exports){
(function (process){
/**
...
},{"_process":1,"object-assign":41,"prop-types/checkPropTypes":43}],46:[function(require,module,exports){
/** @license React v16.13.1
...
},{"./cjs/react.development.js":45,"./cjs/react.production.min.js":46,"_process":1}],48:[function(require,module,exports){
(function (global){
'use strict';
...
},{"_process":1,"tslib":51}],51:[function(require,module,exports){
(function (global){
/*! *****************************************************************************
...
},{"./lib/Observable.js":53}],53:[function(require,module,exports){
"use strict";
