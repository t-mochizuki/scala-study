...
object Main extends HttpApp with App with PersonSchema {
  ...
  val QueryType = ObjectType("Query", fields[PersonRepo, Unit](
  ...
  @SuppressWarnings(Array("org.wartremover.warts.Any", "org.wartremover.warts.Product",  "org.wartremover.warts.Serializable"))
